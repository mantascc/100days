const PINK   = [209, 138, 106];  // terracotta
const YELLOW = [183, 165, 138];  // sand
const CORAL  = [122, 139,  79];  // olive
const CREAM  = [201, 214, 224];  // sky blue
const DEEP   = [ 74,  58,  42];  // shadow brown
