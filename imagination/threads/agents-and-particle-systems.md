...
# What
The workhorse substrate of the practice: a population of small things, each with a position and a velocity, nudged by jitter, neighbours, forces, or noise, and let loose in a wrapping field. Boids, walkers, pills, morphing letter-particles — the implementation is nearly muscle memory now. Almost every other thread gets *expressed* through this one, which is exactly why it's worth noticing as its own obsession rather than treating it as plumbing.
