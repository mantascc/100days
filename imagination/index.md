...
- [Geodesic great-circle path](techniques/geodesic-great-circle-path.md) · low
- [ImageData double buffer](techniques/imagedata-double-buffer.md) · low
- [Scripted await timeline](techniques/scripted-await-timeline.md) · low
...
- [Desktop-only vs responsive](themes/desktop-only-vs-responsive.md) · low

## Sources — what feeds the work

- [Brownian motion & Markov processes](sources/brownian-markov.md) · high
- [Vicsek flocking & Reynolds boids](sources/vicsek-flocking.md) · high
- [Bauhaus & early computer graphics](sources/bauhaus-early-computer-graphics.md) · medium
- [Graph theory algorithms](sources/graph-theory-algorithms.md) · medium
- [Kuramoto oscillators & firefly sync](sources/kuramoto-fireflies.md) · medium
- [Perlin noise](sources/perlin-noise.md) · medium
- [Schelling segregation model](sources/schelling-segregation.md) · medium
...
- [Lens-wave extensions](seeds/lens-wave-extensions.md) · low
